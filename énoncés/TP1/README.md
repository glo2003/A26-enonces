...
- [Créer un produit](fonctionnels/creer-produit.md)
- [Créer un vendeur](fonctionnels/creer-vendeur.md)
- [Obtenir un vendeur](fonctionnels/obtenir-vendeur.md)

## Requis de processus

- [Conventions Git](processus/conventions-git.md)
...
|-------------------|-------------|----------|---------------|
| Qualité technique | 70%         | 100.00%  | 70.00%        |
